...
class QuasiMeromorphicJacobiFormsRing(FormsRing_abstract, CommutativeAlgebra, UniqueRepresentation):
    r"""
...
class QuasiWeakJacobiFormsRing(FormsRing_abstract, CommutativeAlgebra, UniqueRepresentation):
    r"""
...
class QuasiJacobiFormsRing(FormsRing_abstract, CommutativeAlgebra, UniqueRepresentation):
    r"""
...
class MeromorphicJacobiFormsRing(FormsRing_abstract, CommutativeAlgebra, UniqueRepresentation):
    r"""
...
class WeakJacobiFormsRing(FormsRing_abstract, CommutativeAlgebra, UniqueRepresentation):
    r"""
...
class JacobiFormsRing(FormsRing_abstract, CommutativeAlgebra, UniqueRepresentation):
    r"""
...
class CuspJacobiFormsRing(FormsRing_abstract, CommutativeAlgebra, UniqueRepresentation):
    r"""
